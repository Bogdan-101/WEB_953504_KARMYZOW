...
namespace WEB_953504_KARMYZOW.Areas.Admin.Pages
{
    public class CreateModel : PageModel
    {
        ...
        public CreateModel(
            WEB_953504_KARMYZOW.Data.ApplicationDbContext context, IWebHostEnvironment env
        )
        {
            _context = context;
            _environment = env;
        ...
        {
            ViewData["GameGroupId"] =
                new SelectList(_context.GameGroups, "GameGroupId", "GroupName");
            return Page();
        }
